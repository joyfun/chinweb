export default {
  ...
  links: {
    ...
    Timeout: 'Timeout(ms)',
    retries: 'Retries',
    'max read bit count': 'Max Read Bits',
    'max read register count': 'Max Read Register',
    'max write register count': 'Max Write Register',
    'discard data delay': 'time out discard(ms)',
    'use multiple write commands': 'Mult-Write',
    'comm port id (manual)': 'Ser-Port Number',
    'slave id': 'Slave ID',
    'baud rate': 'Baud Rate',
    'data bits': 'Date Bits',
    'stop bits': 'Stop Bits',
    ...
    'type': 'Type',
    'offset': 'Offset',
    'number of registers': 'Num of Registers',
    'data type': 'Data Type',
    'bit': 'Bit',
    'value': 'Value',
    'scaling': 'Scale',
    ...
    user: 'User Name',
    password: 'Password',
    'add ip connection': 'Add IP Dev',
    'add serial connection': 'Add RS485 Dev',
    'edit': 'Edit',
    'restart': 'Restart',
    'stop': 'Stop',
    'remove': 'Delete',
    ...
    'Add device': 'Add Sub Dev',
    'Query device': 'Query Dev',
    'Add data point': 'Add DataPoint',
    'Delete': 'Delete',
    'Update': 'Update',
    'bits': 'Bits',
    'linkRef': 'LinkRef',
    'Import': 'Import Model',
    'linkmark': 'Link Model Data',
